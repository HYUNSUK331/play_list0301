...
import 'package:the_last_playlist/repo/play_list_network_repository.dart';
                                      ...
                                      SizedBox(
                                        ...
                                        child:
                                            Obx(()=>Checkbox(
                                                ...
                                                onChanged: (value) {
                                                  controller.isCheckList[index] = value!;
                                                })),
                                        ),
            ...
            Container(
              ...
              child: ElevatedButton(onPressed: () async {
                ...
                for(int i = 0; i < musicData.length; i++){
                  if(controller.isCheckList[i] == true){
                    musicList.add(musicData[i].id.toString());
                    //widget.snapshot.data[widget.index].lengthist == Constants.musicList[i].id;
                  }
                }

                await playListNetworkRepository.updatelist(pLkey,musicList).then((value) =>
                {
                  print("value"),
                  print(value),
                  // parent?.setState(() {}),
